...
Starting from 210530_model_test
I adapt to run just 1 round, and remove all the code involved in the propagation
step. The code here should match the last version of the model, named as 210601
