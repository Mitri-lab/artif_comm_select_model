# -*- coding: utf-8 -*-
"""
Script adapted to simmulate with different number of time steps. I manually changed the parameter "time_steps" to simulate the desired times for the desired conditions.
"""
...
enter_path = "/mnt/c/Users/pablo/Desktop/aug2025/" #specify path to store results of the simulation
...
time_lim = 120 #time steps within each round (between t_0 and t_end)
...
list_prop = ["d3", "p", "pip", "m", "mip"]
list_treat = ["s", "s", "s", "s","s"]
