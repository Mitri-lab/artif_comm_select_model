...
path_save = "/Users/pablo/Desktop/jun2023/"
...
def my_boxplot(x, y):
    ...
    fig=plt.figure(figsize=(len(conditions_to_plot)*3, 5))
...
#COMPARE PROPAGATIONS, THIS IS THE ONE UPDATED
props = ["DS", "DS_nomut", "DR", "DR_nomut"]
...
for comb in combs:
    ...
    df_sw = pd.concat([df_sw,df_now])
df_sw.to_csv(path_save + "dfw_"+what+".csv")
