...
We have folders named as the species set followed by the number of species in teh subsample. Inside we have a folder corresponding
to the particular subsample with tha number of species. Inside, we have a folder corresponding to each propagation method. The fist part of the name indicates the method:
- d3 : disassembly 
- p : propagule
- m : migrant pool
