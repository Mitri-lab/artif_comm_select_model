...
The results will have folders named as teh factor times which we multiply the bottleneck. (1 would be the standard which is 210822 folder)
...
Inside the folders, different.csv files with all the information will be generated (you can see a description in the word document "ibm_guide"),
as well as a folder "per_round" where we include plots at some particular rounds.
