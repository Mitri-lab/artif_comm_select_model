...
In the current directory, in order to save space, we have removed within each repeat of each propagation method:
- per_round folder (with plots and extra information)
- grid0... pickle files (initial system at each round in pickle format)
- sp_tube (pickle file)
- df_st (.csv file storing all the strains that appear)
